...
#  Jul 02, 2022 10:57:01 AM CEST  platform: Darwin
set vTcl(timestamp) ""
...
proc vTclWindow.top1 {base} {
    ...
    wm geometry $top 969x675+890+328
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    canvas $site_3_0.can46 \
        -background $vTcl(actual_gui_bg) -borderwidth 2 -closeenough 1.0 \
        -height 581 -insertbackground black -relief ridge \
        -selectbackground #c4c4c4 -selectforeground black -width 461 
    vTcl:DefineAlias "$site_3_0.can46" "Canvas1" vTcl:WidgetProc "Toplevel1" 1
    place $site_3_0.can46 \
        -in $site_3_0 -x 0 -relx 0.021 -y 0 -rely 0.016 -width 0 \
        -relwidth 0.958 -height 0 -relheight 0.957 -anchor nw \
        -bordermode ignore 
    ...
    scale $site_5_0.sca46 \
        ...
        -tickinterval 0.0 -to 2.1 -troughcolor #d9d9d9 -variable body_width 
