...
#  Jul 01, 2022 10:32:49 PM CEST  platform: Darwin
set vTcl(timestamp) ""
...
proc vTclWindow.top1 {base} {
    ...
    wm geometry $top 969x675+888+484
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    frame $top.fra46 \
        ...
        -height 607 -highlightcolor black -width 491 
    ...
    scale $site_5_0.sca48 \
        ...
        -font TkDefaultFont -foreground $vTcl(actual_gui_fg) -from -10.0 \
        -highlightcolor black -label X -length 350 -orient horizontal \
        -resolution 0.1 -tickinterval 0.0 -to 10.0 -troughcolor #d9d9d9 \
        -variable x_pos_org 
    ...
    scale $site_5_0.sca49 \
        ...
        -background $vTcl(actual_gui_bg) -bigincrement 0.0 \
        -font TkDefaultFont -foreground $vTcl(actual_gui_fg) -from -10.0 \
        -highlightcolor black -label Y -length 347 -orient horizontal \
        -resolution 0.1 -tickinterval 0.0 -to 10.0 -troughcolor #d9d9d9 \
        -variable y_pos_org 
    ...
    scale $site_5_0.sca50 \
        -activebackground $vTcl(analog_color_m) \
        -background $vTcl(actual_gui_bg) -bigincrement 0.0 \
        -font TkDefaultFont -foreground $vTcl(actual_gui_fg) -from -180.0 \
        -highlightcolor black -label Theta -length 349 -orient horizontal \
        -resolution 0.1 -tickinterval 0.0 -to 180.0 -troughcolor #d9d9d9 
    ...
    scale $site_5_0.sca46 \
        -activebackground $vTcl(analog_color_m) \
        -background $vTcl(actual_gui_bg) -bigincrement 0.0 \
        -font TkDefaultFont -foreground $vTcl(actual_gui_fg) -from 0.1 \
        -highlightcolor black -label Width -length 346 -orient horizontal \
        -resolution 0.1 -tickinterval 0.0 -to 2.1 -troughcolor #d9d9d9 \
        -variable body_width 
    ...
    scale $site_5_0.sca49 \
        -activebackground $vTcl(analog_color_m) \
        -background $vTcl(actual_gui_bg) -bigincrement 0.0 \
        -font TkDefaultFont -foreground $vTcl(actual_gui_fg) -from -5.0 \
        -highlightcolor black -label Right -length 304 -orient horizontal \
        -resolution 0.1 -tickinterval 0.0 -to 5.0 -troughcolor #d9d9d9 \
        -variable v_right 
    ...
    scale $site_5_0.sca50 \
        ...
        -background $vTcl(actual_gui_bg) -bigincrement 0.0 \
        -font TkDefaultFont -foreground $vTcl(actual_gui_fg) -from -5.0 \
        -highlightcolor black -label Left -length 314 -orient horizontal \
        -resolution 0.1 -tickinterval 0.0 -to 5.0 -troughcolor #d9d9d9 \
        -variable v_left 
    ...
    scale $site_5_0.sca51 \
        ...
        -highlightcolor black -label Right -length 314 -orient horizontal \
        -resolution 0.1 -tickinterval 0.0 -to 1.0 -troughcolor #d9d9d9 \
        -variable a_right 
    vTcl:DefineAlias "$site_5_0.sca51" "Scale1_2" vTcl:WidgetProc "Toplevel1" 1
    scale $site_5_0.sca52 \
        ...
        -resolution 0.1 -tickinterval 0.0 -to 1.0 -troughcolor #d9d9d9 \
        -variable a_left 
    vTcl:DefineAlias "$site_5_0.sca52" "Scale1_1_1" vTcl:WidgetProc "Toplevel1" 1
    ...
    scale $site_5_0.sca49 \
        ...
        -highlightcolor black -label Duration -length 314 -orient horizontal \
        -resolution 0.1 -tickinterval 0.0 -to 30.0 -troughcolor #d9d9d9 \
        -variable timing_duration 
    vTcl:DefineAlias "$site_5_0.sca49" "Scale2" vTcl:WidgetProc "Toplevel1" 1
    place $site_5_0.sca49 \
    ...
    scale $site_5_0.sca48 \
        ...
        -background $vTcl(actual_gui_bg) -bigincrement 0.0 \
        -font TkDefaultFont -foreground $vTcl(actual_gui_fg) -from 0.0 \
        -highlightcolor black -label Interval -length 314 -orient horizontal \
        -resolution 0.1 -tickinterval 0.0 -to 1.0 -troughcolor #d9d9d9 \
        -variable timing_interval 
    vTcl:DefineAlias "$site_5_0.sca48" "Scale1" vTcl:WidgetProc "Toplevel1" 1
    place $site_5_0.sca48 \
    ...
    ttk::labelframe $top.tLa46 \
        -text {Actual and Dead reckoned Position} -width 411 -height 157 
    ...
    entry $site_3_0.ent46 \
        ...
        -width 10 
    vTcl:DefineAlias "$site_3_0.ent46" "x_actual" vTcl:WidgetProc "Toplevel1" 1
    entry $site_3_0.ent47 \
        -background white -font TkFixedFont -foreground $vTcl(actual_gui_fg) \
        -highlightcolor black -insertbackground black \
        -selectbackground #c4c4c4 -selectforeground black -state disabled \
        -width 10 
    vTcl:DefineAlias "$site_3_0.ent47" "y_actual" vTcl:WidgetProc "Toplevel1" 1
    entry $site_3_0.ent48 \
        -background white -font TkFixedFont -foreground $vTcl(actual_gui_fg) \
        -highlightcolor black -insertbackground black \
        -selectbackground #c4c4c4 -selectforeground black -state disabled \
        -width 10 
    vTcl:DefineAlias "$site_3_0.ent48" "theta_actual" vTcl:WidgetProc "Toplevel1" 1
    entry $site_3_0.ent49 \
        -background white -font TkFixedFont -foreground $vTcl(actual_gui_fg) \
        -highlightcolor black -insertbackground black \
        -selectbackground #c4c4c4 -selectforeground black -state disabled \
        -width 10 
    vTcl:DefineAlias "$site_3_0.ent49" "v_final_left" vTcl:WidgetProc "Toplevel1" 1
    entry $site_3_0.ent50 \
        -background white -font TkFixedFont -foreground $vTcl(actual_gui_fg) \
        -highlightcolor black -insertbackground black \
        -selectbackground #c4c4c4 -selectforeground black -state disabled \
        -width 10 
    vTcl:DefineAlias "$site_3_0.ent50" "x_dr" vTcl:WidgetProc "Toplevel1" 1
    entry $site_3_0.ent51 \
        -background white -font TkFixedFont -foreground $vTcl(actual_gui_fg) \
        -highlightcolor black -insertbackground black \
        -selectbackground #c4c4c4 -selectforeground black -state disabled \
        -width 76 
    vTcl:DefineAlias "$site_3_0.ent51" "y_dr" vTcl:WidgetProc "Toplevel1" 1
    entry $site_3_0.ent52 \
        -background white -font TkFixedFont -foreground $vTcl(actual_gui_fg) \
        -highlightcolor black -insertbackground black \
        -selectbackground #c4c4c4 -selectforeground black -state disabled \
        -width 10 
    vTcl:DefineAlias "$site_3_0.ent52" "theta_dr" vTcl:WidgetProc "Toplevel1" 1
    entry $site_3_0.ent53 \
        -background white -font TkFixedFont -foreground $vTcl(actual_gui_fg) \
        -highlightcolor black -insertbackground black \
        -selectbackground #c4c4c4 -selectforeground black -state disabled \
        -width 10 
    vTcl:DefineAlias "$site_3_0.ent53" "v_final_right" vTcl:WidgetProc "Toplevel1" 1
    entry $site_3_0.ent54 \
        -background white -font TkFixedFont -foreground $vTcl(actual_gui_fg) \
        -highlightcolor black -insertbackground black \
        -selectbackground #c4c4c4 -selectforeground black -state disabled \
        -width 10 
    vTcl:DefineAlias "$site_3_0.ent54" "x_dr2" vTcl:WidgetProc "Toplevel1" 1
    entry $site_3_0.ent55 \
        -background white -font TkFixedFont -foreground $vTcl(actual_gui_fg) \
        -highlightcolor black -insertbackground black \
        -selectbackground #c4c4c4 -selectforeground black -state disabled \
        -width 10 
    vTcl:DefineAlias "$site_3_0.ent55" "y_dr2" vTcl:WidgetProc "Toplevel1" 1
    entry $site_3_0.ent56 \
        -background white -font TkFixedFont -foreground $vTcl(actual_gui_fg) \
        -highlightcolor black -insertbackground black \
        -selectbackground #c4c4c4 -selectforeground black -state disabled \
        -width 10 
    vTcl:DefineAlias "$site_3_0.ent56" "theta_dr2" vTcl:WidgetProc "Toplevel1" 1
    ...
    place $site_3_0.lab52 \
        -in $site_3_0 -x 0 -relx 0.609 -y 0 -rely 0.123 -width 0 \
        -relwidth 0.145 -height 0 -relheight 0.142 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab53 \
        -in $site_3_0 -x 0 -relx 0.803 -y 0 -rely 0.121 -width 0 \
        -relwidth 0.17 -height 0 -relheight 0.146 -anchor nw \
        -bordermode ignore 
    place $site_3_0.ent46 \
        -in $site_3_0 -x 0 -relx 0.365 -y 0 -rely 0.278 -width 76 -relwidth 0 \
        -height 20 -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.ent47 \
        -in $site_3_0 -x 0 -relx 0.365 -y 0 -rely 0.42 -width 76 -relwidth 0 \
        -height 20 -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.ent48 \
        -in $site_3_0 -x 0 -relx 0.365 -y 0 -rely 0.568 -width 76 -relwidth 0 \
        -height 20 -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.ent49 \
        -in $site_3_0 -x 0 -relx 0.365 -y 0 -rely 0.71 -width 76 -relwidth 0 \
        -height 20 -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.ent50 \
        -in $site_3_0 -x 0 -relx 0.581 -y 0 -rely 0.278 -width 76 -relwidth 0 \
        -height 20 -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.ent51 \
        -in $site_3_0 -x 0 -relx 0.581 -y 0 -rely 0.42 -width 76 -relwidth 0 \
        -height 20 -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.ent52 \
        -in $site_3_0 -x 0 -relx 0.581 -y 0 -rely 0.556 -width 76 -relwidth 0 \
        -height 20 -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.ent53 \
        -in $site_3_0 -x 0 -relx 0.581 -y 0 -rely 0.71 -width 76 -relwidth 0 \
        -height 20 -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.ent54 \
        -in $site_3_0 -x 0 -relx 0.806 -y 0 -rely 0.278 -width 76 -relwidth 0 \
        -height 20 -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.ent55 \
        -in $site_3_0 -x 0 -relx 0.806 -y 0 -rely 0.42 -width 76 -relwidth 0 \
        -height 20 -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.ent56 \
        -in $site_3_0 -x 0 -relx 0.806 -y 0 -rely 0.556 -width 76 -relwidth 0 \
        -height 20 -relheight 0 -anchor nw -bordermode ignore 
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.fra46 \
        -in $top -x 0 -relx 0.031 -y 0 -rely 0.044 -width 0 -relwidth 0.496 \
    ...
    place $top.tLa46 \
        -in $top -x 0 -relx 0.543 -y 0 -rely 0.706 -width 0 -relwidth 0.435 \
