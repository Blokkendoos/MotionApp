...
#  Jul 04, 2022 08:09:07 AM CEST  platform: Darwin
set vTcl(timestamp) ""
...
proc vTclWindow.top1 {base} {
    ...
    wm geometry $top 969x675+928+319
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    place $site_3_0.lab57 \
        -in $site_3_0 -x 0 -relx 0.569 -y 0 -rely 0.71 -width 0 \
        -relwidth 0.118 -height 0 -relheight 0.123 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab58 \
        -in $site_3_0 -x 0 -relx 0.569 -y 0 -rely 0.278 -width 0 \
        -relwidth 0.166 -height 0 -relheight 0.123 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab59 \
        -in $site_3_0 -x 0 -relx 0.569 -y 0 -rely 0.42 -width 0 \
        -relwidth 0.166 -height 0 -relheight 0.123 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab60 \
        -in $site_3_0 -x 0 -relx 0.569 -y 0 -rely 0.568 -width 0 \
        -relwidth 0.166 -height 0 -relheight 0.123 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab61 \
        -in $site_3_0 -x 0 -relx 0.782 -y 0 -rely 0.278 -width 0 \
        -relwidth 0.166 -height 0 -relheight 0.123 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab62 \
        -in $site_3_0 -x 0 -relx 0.782 -y 0 -rely 0.42 -width 0 \
        -relwidth 0.166 -height 0 -relheight 0.123 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab63 \
        -in $site_3_0 -x 0 -relx 0.782 -y 0 -rely 0.568 -width 0 \
        -relwidth 0.166 -height 0 -relheight 0.123 -anchor nw \
        -bordermode ignore 
    ###################
    # SETTING GEOMETRY
